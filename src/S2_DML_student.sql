...
-- Waarom werkt dit niet? SELECT naam, voorl FROM medewerkers WHERE naam <> 'JANSEN' AND voorl <> 'R';
...
VALUES (8001, 'DOE', 'J', 'STAGIAIR', 7369, '2002-04-14', 400, 20)
...
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
INSERT INTO uitvoeringen (cursus, begindatum, docent, locatie)
VALUES ('D&P', '2023-9-24', 7369, 'LEERDAM')
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
INSERT INTO uitvoeringen (cursus, begindatum, docent, locatie)
VALUES ('D&P', '2023-9-12', 7369, 'LEERDAM')
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
INSERT INTO inschrijvingen (cursist, cursus, begindatum)
VALUES (7839, 'D&P', '2023-9-24')
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
INSERT INTO inschrijvingen (cursist, cursus, begindatum)
VALUES (7698, 'D&P', '2023-9-24')
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
INSERT INTO inschrijvingen (cursist, cursus, begindatum)
VALUES (7902, 'D&P', '2023-9-12')
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
...
--Delete lukt niet zonder because werknemersnummer wordt ergens anders genoemd
...
INSERT INTO medewerkers (mnr, naam, voorl, functie, chef, gbdatum, maandsal, afd)
VALUES (8003, 'DUNDAR', 'A', 'MANAGER', 7839, '2003-04-14', 2500, null)
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
...
UPDATE medewerkers SET afdeling = 60 WHERE mnr = 8003;
-- [TEST]
